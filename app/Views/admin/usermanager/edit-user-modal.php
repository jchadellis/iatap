...
<div class="modal-body">
            ...
            <div class="col-4">
                ...
                <div class="form-check">
                    <input 
                        ...
                        id="groups-<?= $group->id ?>" 
                        <?= ( in_array(strtolower($group->name),$data->getGroups())) ? 'checked' : '' ?> 
                    >
    ...
    <div class="row mb-2">
        ...
        <div class="col-4">
            <?php if( $data->getPermissions() !== null ) : ?>
            <div class="form-check">
                <input 
                    class="form-check-input" 
                    type="checkbox" 
                    ...
                    <?= $data->hasPermission($permission->group.'.'.$permission->function) ? 'checked' : '' ?> 
                >
